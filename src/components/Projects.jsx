               ...
               <AnimatePresence>
                  {visibleWorks.map((project, index) => (
                     <motion.div
                        ...
                        className={`group bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden hover:border-zinc-700 transition-all shadow-lg shadow-black/20 ${project.url ? 'cursor-pointer' : 'cursor-default'}`}
                     >
